...
<head>
<meta charset="utf-8">
<title>Declarative Headline Border Container</title>
...
<body class="claro">
	...
	<div id="borderContainer", data-dojo-type="dijit/layout/BorderContainer" data-dojo-props="design:'headline', gutters:true" >
    	<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="splitter:true, region:'top'" style="width:100%; height:10%; overflow:hidden;">Top Pane</div>
    	...
    	<div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="splitter:true, region:'center'" style="width:100%; overflow:hidden;">Center Pane</div>
