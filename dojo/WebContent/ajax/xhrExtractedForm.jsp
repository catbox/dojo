...
<head>
<meta charset="utf-8">
<title>XHR Extracted Form</title>
...
<body class="claro">
	<h1>XHR Extracted Form Validator</h1>
		...
		require(["dojo/dom", "dojo/on", "dojo/request", "dojo/dom-form"],
			function(dom, on, request, domForm) {
				...
				on(form, "submit", function(evt) {
					...
					var uname = domForm.fieldToObject(dom.byId("formNode").username);
					var pwd = domForm.fieldToObject(dom.byId("formNode").password);
					var lang = "ES";
