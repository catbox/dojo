...
<body class="claro">
	...
	<script>	
		require(["dojo/dom", "dojo/dom-construct","modules/loginpane", "dojo/domReady!"], 
			...
			if(mainNode!=null) {				  			
		    	var formNode = domConstruct.toDom("<table><tr><td style='width:50%; min-width:400px;'><h1 id='logoPane' style='margin-left:10px;'>Phantom</h1></td><td style='width:50%; min-width:400px;'><form id='loginForm'><div id='loginPane'></div></form></td></tr></table>");	    	
