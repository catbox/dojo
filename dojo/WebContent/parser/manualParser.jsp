...
<body class="claro">
	...
	<script>
		require(["dojo/parser", "dijit/form/Form", "dijit/form/TextBox", "dijit/form/Button", "dojo/domReady!"], function(parser){
			/*		
			The Dojo Parser module is used to convert specially decorated nodes in the DOM and convert them into Dijits, Widgets or other Objects. 
			By decorated we mean use of a data-dojo-type attribute. 
			Any “Class” (or object, such as the ones created by dojo.declare) can be instantiated by using a data-dojo-type attribute on some node in the DOM, and create a widget out of it.
			*/
			parser.parse();
		});
	</script>
